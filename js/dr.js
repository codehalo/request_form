$(document).ready(function(){
	...
	function page_5() {
		...
		var formTypeId = $(".current-form").attr("id");
		$(".p5_form_body").hide();
		$("#" + formTypeId + "-5-container").show();
		$("#page_5_title").text($("#" + formTypeId + " .chk-txt").text());

		if($("#comp-approval .opt-chk-select").parent().find(".chk-txt").text() == "Yes") {
			$("#email-ca-no").hide();
			$("#email-ca-yes").show();
	...
	var dispatch_table = [page_1, page_2, page_3, page_4, page_5];
